...
import (
	...
	"errors"
	"fmt"
	"github.com/Jarijaas/go-tls-exposed/cpu"
	"io"
	"net"
	"runtime"
	"sort"
...
type Config struct {
	...
	RawClientHello	[]byte // If set, uses this instead of constructing hello based on configured parameters
}
...
func (c *Config) Clone() *Config {
	...
	return &Config{
		...
		Scts: c.Scts,
		OscpStapling: c.OscpStapling,
		SupportedCurves: c.SupportedCurves,
		SupportedPoints: c.SupportedPoints,
		SecureRenegotiationSupported: c.SecureRenegotiationSupported,
		SupportedSignatureAlgorithms: c.SupportedSignatureAlgorithms,
		SupportedVersions: c.SupportedVersions,
		ClientHelloVersion: c.ClientHelloVersion,
		TicketSupported: c.TicketSupported,
		PskModes: c.PskModes,
		Extensions: c.Extensions,
		RawClientHello: c.RawClientHello,
	}
}
